#' Fit a univariate mixed model in a concurrent FMM
#'
...
unimm_conc <- function(l) {
  ...
  # can verify by comparing with nlme::lme() and seeing 2 columns of residuals
  # in lme: mod$residuals
